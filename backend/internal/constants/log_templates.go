...
const (
	...
	LogRecipeUpdateSuccess    = "brew recipe updated: id=%d"
	LogRecipeUpdateFailed     = "brew recipe update failed: id=%d"
	LogRecipeForkSuccess      = "brew recipe forked: source_id=%d new_id=%d"
	LogRecipeForkFailed       = "brew recipe fork failed: source_id=%d"
